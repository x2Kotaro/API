...
local a a={cache={}, load=function(b)if not a.cache[b]then a.cache[b]={c=a[b]()}end return a.cache[b].c end}do function a.a()local b=game:GetService"RunService"local d=
    ...
    return af
        ...
        function ac.New(ae, af)
            ...
            -- สร้าง ParagraphDescWrapper เฉพาะสำหรับ Paragraph
            local ParagraphDescWrapper = aa.NewRoundFrame(10, "Squircle", {
                AutomaticSize = 'Y',
                Size = UDim2.new(1, 0, 0, 0),
                LayoutOrder = 2,
                Name = 'ParagraphDescWrapper',
            ...
            -- ซ่อนถ้าไม่มีคำอธิบาย
            if not af.Desc or af.Desc == "" then
                ParagraphDescWrapper.Visible = false
            end
            ...
            af.UIElements.Container = ab("Frame", {
                ...
                -- Description with Special Wrapper
                ParagraphDescWrapper,
                
                -- Buttons Section (ถ้ามี)
                (af.Buttons and #af.Buttons > 0) and ab("Frame", {
            ...
            if af.Buttons and #af.Buttons > 0 then
                local buttonsFrame = af.UIElements.Container:FindFirstChildOfClass("Frame")
                if buttonsFrame then
                    for aj, ak in next, af.Buttons do
                        local al = ad(ak.Title, ak.Icon, ak.Callback, "White", buttonsFrame)
